...
namespace Liny.Core.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateClickBasedAudienceGroupResponse
        : IEquatable<CreateClickBasedAudienceGroupResponse>
    {
        /// <summary>
        /// The audience ID.
        /// </summary>
        ...
        public bool IsIfaAudience { get; set; } = false;
        ...
        public override bool Equals(object obj)
        {
            ...
            if (ReferenceEquals(this, obj))
                return true;
            return obj.GetType() == GetType() && Equals((CreateClickBasedAudienceGroupResponse)obj);
        }

        /// <summary>
        /// Returns true if CreateClickBasedAudienceGroupResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateClickBasedAudienceGroupResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateClickBasedAudienceGroupResponse other)
        {
            if (other is null)
                return false;
            ...
            return (
                ...
                && (
                    ...
                    || ClickUrl != null && ClickUrl.Equals(other.ClickUrl)
                )
...
#pragma warning disable 1591
        ...
        public static bool operator ==(
            CreateClickBasedAudienceGroupResponse left,
            CreateClickBasedAudienceGroupResponse right
        )
        {
