    ...
    public partial class TestWebhookEndpointResponse : IEquatable<TestWebhookEndpointResponse>
    {
        ...
        public bool Equals(TestWebhookEndpointResponse other)
        {
            ...
            return (Success == other.Success || Success.Equals(other.Success))
                ...
                && (StatusCode == other.StatusCode || StatusCode.Equals(other.StatusCode))
                && (Reason == other.Reason || Reason != null && Reason.Equals(other.Reason))
                && (Detail == other.Detail || Detail != null && Detail.Equals(other.Detail));
        }
...
#pragma warning disable 1591
        ...
        public static bool operator ==(
            TestWebhookEndpointResponse left,
            TestWebhookEndpointResponse right
        )
        {
