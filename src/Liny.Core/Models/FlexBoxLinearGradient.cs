...
namespace Liny.Core.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class FlexBoxLinearGradient
        : FlexBoxBackground,
            IEquatable<FlexBoxLinearGradient>
    {
        /// <summary>
        /// Gets or Sets Angle
        /// </summary>
        ...
        public bool Equals(FlexBoxLinearGradient other)
        {
            ...
            return (Angle == other.Angle || Angle != null && Angle.Equals(other.Angle))
                && (
                    StartColor == other.StartColor
                    || StartColor != null && StartColor.Equals(other.StartColor)
                )
                && (
                    EndColor == other.EndColor
                    || EndColor != null && EndColor.Equals(other.EndColor)
                )
                && (
                    CenterColor == other.CenterColor
                    || CenterColor != null && CenterColor.Equals(other.CenterColor)
                )
                && (
                    CenterPosition == other.CenterPosition
                    || CenterPosition != null && CenterPosition.Equals(other.CenterPosition)
                );
        }
