    ...
    public partial class Membership : IEquatable<Membership>
    {
        ...
        public bool Equals(Membership other)
        {
            ...
            return (MembershipId == other.MembershipId || MembershipId.Equals(other.MembershipId))
                ...
                && (MemberCount == other.MemberCount || MemberCount.Equals(other.MemberCount))
                && (
                    MemberLimit == other.MemberLimit
                    || MemberLimit != null && MemberLimit.Equals(other.MemberLimit)
                )
                && (
                    IsInAppPurchase == other.IsInAppPurchase
                    || IsInAppPurchase.Equals(other.IsInAppPurchase)
                )
                && (IsPublished == other.IsPublished || IsPublished.Equals(other.IsPublished));
        }
