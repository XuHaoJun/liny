...
{ 
    ...
    public partial class SubscribedMembershipUser : IEquatable<SubscribedMembershipUser>
    {
        ...
        public bool Equals(SubscribedMembershipUser other)
        {
            ...
            return 
                (
                    ...
                    MembershipNo.Equals(other.MembershipNo)
                ) && 
                (
                    JoinedTime == other.JoinedTime ||
                    
                    JoinedTime.Equals(other.JoinedTime)
                ) && 
                (
                    NextBillingDate == other.NextBillingDate ||
                    NextBillingDate != null &&
                    NextBillingDate.Equals(other.NextBillingDate)
                ) && 
                (
        ...
        public static bool operator ==(SubscribedMembershipUser left, SubscribedMembershipUser right)
        {
