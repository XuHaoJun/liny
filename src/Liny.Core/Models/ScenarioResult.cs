    ...
    public partial class ScenarioResult : IEquatable<ScenarioResult>
    {
        ...
        public bool Equals(ScenarioResult other)
        {
            ...
            return (
                    ...
                    || ScenarioId != null && ScenarioId.Equals(other.ScenarioId)
                )
                && (Revision == other.Revision || Revision.Equals(other.Revision))
                && (StartTime == other.StartTime || StartTime.Equals(other.StartTime))
                && (EndTime == other.EndTime || EndTime.Equals(other.EndTime))
                && (
                    ResultCode == other.ResultCode
                    || ResultCode != null && ResultCode.Equals(other.ResultCode)
                )
                && (
                ...
                && (
                    ...
                    || ErrorReason != null && ErrorReason.Equals(other.ErrorReason)
                );
        }
