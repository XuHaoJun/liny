...
namespace Liny.Core.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetMessageEventResponseOverview
        : IEquatable<GetMessageEventResponseOverview>
    {
        /// <summary>
        /// Request ID.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            if (ReferenceEquals(this, obj))
                return true;
            return obj.GetType() == GetType() && Equals((GetMessageEventResponseOverview)obj);
        }

        /// <summary>
        /// Returns true if GetMessageEventResponseOverview instances are equal
        /// </summary>
        /// <param name="other">Instance of GetMessageEventResponseOverview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetMessageEventResponseOverview other)
        {
            if (other is null)
                return false;
            ...
            return (
                ...
                && (Delivered == other.Delivered || Delivered.Equals(other.Delivered))
                && (
...
#pragma warning disable 1591
        ...
        public static bool operator ==(
            GetMessageEventResponseOverview left,
            GetMessageEventResponseOverview right
        )
        {
