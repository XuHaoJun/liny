...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class GetNumberOfMessageDeliveriesResponse : IEquatable<GetNumberOfMessageDeliveriesResponse>
    {
        ...
        public bool Equals(GetNumberOfMessageDeliveriesResponse other)
        {
            ...
            return 
                ...
                (
                    AutoResponse == other.AutoResponse ||
                    
                    AutoResponse.Equals(other.AutoResponse)
                ) && 
                (
                ...
                (
                    ApiBroadcast == other.ApiBroadcast ||
                    
                    ApiBroadcast.Equals(other.ApiBroadcast)
                ) && 
                (
                    ApiPush == other.ApiPush ||
                    
                    ApiPush.Equals(other.ApiPush)
                ) && 
                (
                    ApiMulticast == other.ApiMulticast ||
                    
                    ApiMulticast.Equals(other.ApiMulticast)
                ) && 
                (
                ...
                (
                    ApiReply == other.ApiReply ||
                    
                    ApiReply.Equals(other.ApiReply)
                );
        }
        ...
        public static bool operator ==(GetNumberOfMessageDeliveriesResponse left, GetNumberOfMessageDeliveriesResponse right)
        {
