...
namespace Liny.Core.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class RichMenuRequest : IEquatable<RichMenuRequest>
    {
        /// <summary>
        /// Gets or Sets Size
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            if (ReferenceEquals(this, obj))
                return true;
            return obj.GetType() == GetType() && Equals((RichMenuRequest)obj);
        }

        /// <summary>
        /// Returns true if RichMenuRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of RichMenuRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RichMenuRequest other)
        {
            if (other is null)
                return false;
            ...
            return (Size == other.Size || Size != null && Size.Equals(other.Size))
                && (Selected == other.Selected || Selected.Equals(other.Selected))
                && (Name == other.Name || Name != null && Name.Equals(other.Name))
                && (
                    ChatBarText == other.ChatBarText
                    || ChatBarText != null && ChatBarText.Equals(other.ChatBarText)
                )
                && (
                    Areas == other.Areas
...
#pragma warning disable 1591
        ...
        public static bool operator ==(RichMenuRequest left, RichMenuRequest right)
        {
