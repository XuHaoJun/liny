...
namespace Liny.Core.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuickReplyItem : IEquatable<QuickReplyItem>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            if (ReferenceEquals(this, obj))
                return true;
            return obj.GetType() == GetType() && Equals((QuickReplyItem)obj);
        }

        /// <summary>
        /// Returns true if QuickReplyItem instances are equal
        /// </summary>
        /// <param name="other">Instance of QuickReplyItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuickReplyItem other)
        {
            if (other is null)
                return false;
...
#pragma warning disable 1591
        ...
        public static bool operator ==(QuickReplyItem left, QuickReplyItem right)
        {
