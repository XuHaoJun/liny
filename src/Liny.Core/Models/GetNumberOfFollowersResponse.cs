    ...
    public partial class GetNumberOfFollowersResponse : IEquatable<GetNumberOfFollowersResponse>
    {
        ...
        public bool Equals(GetNumberOfFollowersResponse other)
        {
            ...
            return (Status == other.Status || Status.Equals(other.Status))
                && (Followers == other.Followers || Followers.Equals(other.Followers))
                && (
                    TargetedReaches == other.TargetedReaches
                    || TargetedReaches.Equals(other.TargetedReaches)
                )
                && (Blocks == other.Blocks || Blocks.Equals(other.Blocks));
        }
...
#pragma warning disable 1591
        ...
        public static bool operator ==(
            GetNumberOfFollowersResponse left,
            GetNumberOfFollowersResponse right
        )
        {
