...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateLiffView : IEquatable<UpdateLiffView>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateLiffView {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((UpdateLiffView)obj);
        }

        /// <summary>
        /// Returns true if UpdateLiffView instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdateLiffView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateLiffView other)
        {
            ...
            return 
                ...
                (
                    ModuleMode == other.ModuleMode ||
                    
                    ModuleMode.Equals(other.ModuleMode)
                );
        }
        ...
        public static bool operator ==(UpdateLiffView left, UpdateLiffView right)
        {
