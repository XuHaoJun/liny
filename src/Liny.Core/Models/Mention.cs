...
namespace Liny.Core.Models
{
    ...
    public partial class Mention : IEquatable<Mention>
    {
        ...
        [Required]
        [DataMember(Name = "mentionees", EmitDefaultValue = false)]
        ...
        public bool Equals(Mention other)
        {
            ...
            return (
                Mentionees == other.Mentionees
                || Mentionees != null
                    && other.Mentionees != null
                    && Mentionees.SequenceEqual(other.Mentionees)
            );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (Mentionees != null)
                    hashCode = hashCode * 59 + Mentionees.GetHashCode();
                return hashCode;
            }
        }
