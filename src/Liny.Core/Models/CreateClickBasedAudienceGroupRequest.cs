...
namespace Liny.Core.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateClickBasedAudienceGroupRequest
        : IEquatable<CreateClickBasedAudienceGroupRequest>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            if (ReferenceEquals(this, obj))
                return true;
            return obj.GetType() == GetType() && Equals((CreateClickBasedAudienceGroupRequest)obj);
        }

        /// <summary>
        /// Returns true if CreateClickBasedAudienceGroupRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateClickBasedAudienceGroupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateClickBasedAudienceGroupRequest other)
        {
            if (other is null)
                return false;
...
#pragma warning disable 1591
        ...
        public static bool operator ==(
            CreateClickBasedAudienceGroupRequest left,
            CreateClickBasedAudienceGroupRequest right
        )
        {
