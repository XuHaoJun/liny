...
namespace Liny.Core.Models
{
    ...
    public partial class FlexBox : FlexComponent, IEquatable<FlexBox>
    {
        ...
        public bool Equals(FlexBox other)
        {
            ...
            return (Layout == other.Layout || Layout.Equals(other.Layout))
                && (Flex == other.Flex || Flex.Equals(other.Flex))
                && (
                ...
                && (Spacing == other.Spacing || Spacing != null && Spacing.Equals(other.Spacing))
                ...
                && (
                    ...
                    || BorderColor != null && BorderColor.Equals(other.BorderColor)
                )
                && (
                    BorderWidth == other.BorderWidth
                    || BorderWidth != null && BorderWidth.Equals(other.BorderWidth)
                )
                && (
                    CornerRadius == other.CornerRadius
                    || CornerRadius != null && CornerRadius.Equals(other.CornerRadius)
                )
                && (Width == other.Width || Width != null && Width.Equals(other.Width))
                && (
                    MaxWidth == other.MaxWidth
                    || MaxWidth != null && MaxWidth.Equals(other.MaxWidth)
                )
                && (Height == other.Height || Height != null && Height.Equals(other.Height))
                && (
                    MaxHeight == other.MaxHeight
                    || MaxHeight != null && MaxHeight.Equals(other.MaxHeight)
                )
                && (
                    PaddingAll == other.PaddingAll
                    || PaddingAll != null && PaddingAll.Equals(other.PaddingAll)
                )
                && (
                    PaddingTop == other.PaddingTop
                    || PaddingTop != null && PaddingTop.Equals(other.PaddingTop)
                )
                && (
                    PaddingBottom == other.PaddingBottom
                    || PaddingBottom != null && PaddingBottom.Equals(other.PaddingBottom)
                )
                && (
                    PaddingStart == other.PaddingStart
                    || PaddingStart != null && PaddingStart.Equals(other.PaddingStart)
                )
                && (
                    PaddingEnd == other.PaddingEnd
                    || PaddingEnd != null && PaddingEnd.Equals(other.PaddingEnd)
                )
                ...
                && (AlignItems == other.AlignItems || AlignItems.Equals(other.AlignItems))
                && (
                    Background == other.Background
                    || Background != null && Background.Equals(other.Background)
                );
        }
