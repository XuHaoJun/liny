...
namespace Liny.Core.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallbackRequest : IEquatable<CallbackRequest>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            if (ReferenceEquals(this, obj))
                return true;
            return obj.GetType() == GetType() && Equals((CallbackRequest)obj);
        }

        /// <summary>
        /// Returns true if CallbackRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of CallbackRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallbackRequest other)
        {
            ...
            return (
                ...
                && (
                    Events == other.Events
                    || Events != null && other.Events != null && Events.SequenceEqual(other.Events)
                );
        }
...
#pragma warning disable 1591
        ...
        public static bool operator ==(CallbackRequest left, CallbackRequest right)
        {
