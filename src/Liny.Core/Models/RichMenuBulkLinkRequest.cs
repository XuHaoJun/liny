...
namespace Liny.Core.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class RichMenuBulkLinkRequest : IEquatable<RichMenuBulkLinkRequest>
    {
        /// <summary>
        /// ID of a rich menu
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            if (ReferenceEquals(this, obj))
                return true;
            return obj.GetType() == GetType() && Equals((RichMenuBulkLinkRequest)obj);
        }

        /// <summary>
        /// Returns true if RichMenuBulkLinkRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of RichMenuBulkLinkRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RichMenuBulkLinkRequest other)
        {
            if (other is null)
                return false;
...
#pragma warning disable 1591
        ...
        public static bool operator ==(RichMenuBulkLinkRequest left, RichMenuBulkLinkRequest right)
        {
