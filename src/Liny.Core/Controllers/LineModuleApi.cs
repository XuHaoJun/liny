...
namespace Liny.Core.Controllers
{
    ...
    public class LineModuleApiController : ControllerBase
    {
        ...
        public virtual IActionResult AcquireChatControl(
            [FromRoute(Name = "chatId")] [Required] string chatId,
            [FromBody] AcquireChatControlRequest acquireChatControlRequest
        )
        {
        ...
        public virtual IActionResult DetachModule(
            [FromBody] DetachModuleRequest detachModuleRequest
        )
        {
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200);
        ...
        public virtual IActionResult ReleaseChatControl(
            [FromRoute(Name = "chatId")] [Required] string chatId
        )
        {
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
