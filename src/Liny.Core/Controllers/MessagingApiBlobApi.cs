...
{ 
    ...
    { 
        ...
        public virtual IActionResult GetMessageContent([FromRoute (Name = "messageId")][Required]string messageId)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(System.IO.Stream), description: "OK")]
        public virtual IActionResult GetMessageContentPreview([FromRoute (Name = "messageId")][Required]string messageId)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(GetMessageContentTranscodingResponse), description: "OK")]
        public virtual IActionResult GetMessageContentTranscodingByMessageId([FromRoute (Name = "messageId")][Required]string messageId)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(System.IO.Stream), description: "OK")]
        public virtual IActionResult GetRichMenuImage([FromRoute (Name = "richMenuId")][Required]string richMenuId)
        {
        ...
        public virtual IActionResult SetRichMenuImage([FromRoute (Name = "richMenuId")][Required]string richMenuId, [FromBody]System.IO.Stream body)
        {
