...
namespace Liny.Core.Controllers
{
    ...
    public class LiffApiController : ControllerBase
    {
        ...
        public virtual IActionResult DeleteLIFFApp(
            [FromRoute(Name = "liffId")] [Required] string liffId
        )
        {
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
        ...
        public virtual IActionResult UpdateLIFFApp(
            [FromRoute(Name = "liffId")] [Required] string liffId,
            [FromBody] UpdateLiffAppRequest updateLiffAppRequest
        )
        {
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200);
