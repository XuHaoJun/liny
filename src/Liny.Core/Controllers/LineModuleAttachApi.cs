...
{ 
    ...
    { 
        ...
        public virtual IActionResult AttachModule([FromForm (Name = "grant_type")][Required()]string grantType, [FromForm (Name = "code")][Required()]string code, [FromForm (Name = "redirect_uri")][Required()]string redirectUri, [FromForm (Name = "code_verifier")]string codeVerifier, [FromForm (Name = "client_id")]string clientId, [FromForm (Name = "client_secret")]string clientSecret, [FromForm (Name = "region")]string region, [FromForm (Name = "basic_search_id")]string basicSearchId, [FromForm (Name = "scope")]string scope, [FromForm (Name = "brand_type")]string brandType)
        {
