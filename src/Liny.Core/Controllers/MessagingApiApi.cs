...
namespace Liny.Core.Controllers
{
    ...
    public class MessagingApiApiController : ControllerBase
    {
        ...
        public virtual IActionResult AudienceMatch(
            [FromBody] AudienceMatchMessagesRequest audienceMatchMessagesRequest
        )
        {
        ...
        public virtual IActionResult GetAdPhoneMessageStatistics(
