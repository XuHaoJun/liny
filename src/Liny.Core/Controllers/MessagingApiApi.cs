...
{ 
    ...
    { 
        ...
        /// 
        /// </summary>
        /// <remarks>Send a message using phone number</remarks>
        /// <param name="audienceMatchMessagesRequest"></param>
        /// <response code="200">OK</response>
        [HttpPost]
        [Route("/bot/ad/multicast/phone")]
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("AudienceMatch")]
        public virtual IActionResult AudienceMatch([FromBody]AudienceMatchMessagesRequest audienceMatchMessagesRequest)
        {
        ...
        public virtual IActionResult Broadcast([FromBody]BroadcastRequest broadcastRequest, [FromHeader (Name = "X-Line-Retry-Key")]Guid? xLineRetryKey)
        {
        ...
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        public virtual IActionResult CreateRichMenuAlias([FromBody]CreateRichMenuAliasRequest createRichMenuAliasRequest)
        {
        ...
        public virtual IActionResult DeleteRichMenu([FromRoute (Name = "richMenuId")][Required]string richMenuId)
        {
        ...
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        public virtual IActionResult DeleteRichMenuAlias([FromRoute (Name = "richMenuAliasId")][Required]string richMenuAliasId)
        {
        ...
        /// 
        /// </summary>
        /// <remarks>Get result of message delivery using phone number</remarks>
        /// <param name="date">Date the message was sent  Format: &#x60;yyyyMMdd&#x60; (e.g. &#x60;20190831&#x60;) Time Zone: UTC+9 </param>
        /// <response code="200">OK</response>
        [HttpGet]
        [Route("/v2/bot/message/delivery/ad_phone")]
        [ValidateModelState]
        [SwaggerOperation("GetAdPhoneMessageStatistics")]
        [SwaggerResponse(statusCode: 200, type: typeof(NumberOfMessagesResponse), description: "OK")]
        public virtual IActionResult GetAdPhoneMessageStatistics([FromQuery (Name = "date")][Required()]string date)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(GetAggregationUnitNameListResponse), description: "OK")]
        public virtual IActionResult GetAggregationUnitNameList([FromQuery (Name = "limit")]string limit, [FromQuery (Name = "start")]string start)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(GetAggregationUnitUsageResponse), description: "OK")]
        ...
        public virtual IActionResult GetFollowers([FromQuery (Name = "start")]string start, [FromQuery (Name = "limit")]int? limit)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(GroupMemberCountResponse), description: "OK")]
        public virtual IActionResult GetGroupMemberCount([FromRoute (Name = "groupId")][Required]string groupId)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(GroupUserProfileResponse), description: "OK")]
        public virtual IActionResult GetGroupMemberProfile([FromRoute (Name = "groupId")][Required]string groupId, [FromRoute (Name = "userId")][Required]string userId)
        {
        ...
        public virtual IActionResult GetGroupMembersIds([FromRoute (Name = "groupId")][Required]string groupId, [FromQuery (Name = "start")]string start)
        {
        ...
        public virtual IActionResult GetGroupSummary([FromRoute (Name = "groupId")][Required]string groupId)
        {
        ...
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Unable to get information about the memberships.")]
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(GetMembershipSubscriptionResponse), description: "OK")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "An invalid user ID is specified.")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Unable to get information about the membership to which the user subscribes.")]
        public virtual IActionResult GetMembershipSubscription([FromRoute (Name = "userId")][Required]string userId)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(QuotaConsumptionResponse), description: "OK")]
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(NarrowcastProgressResponse), description: "OK")]
        public virtual IActionResult GetNarrowcastProgress([FromQuery (Name = "requestId")][Required()]string requestId)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(NumberOfMessagesResponse), description: "OK")]
        public virtual IActionResult GetNumberOfSentBroadcastMessages([FromQuery (Name = "date")][Required()]string date)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(NumberOfMessagesResponse), description: "OK")]
        public virtual IActionResult GetNumberOfSentMulticastMessages([FromQuery (Name = "date")][Required()]string date)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(NumberOfMessagesResponse), description: "OK")]
        public virtual IActionResult GetNumberOfSentPushMessages([FromQuery (Name = "date")][Required()]string date)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(NumberOfMessagesResponse), description: "OK")]
        public virtual IActionResult GetNumberOfSentReplyMessages([FromQuery (Name = "date")][Required()]string date)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(NumberOfMessagesResponse), description: "OK")]
        public virtual IActionResult GetPNPMessageStatistics([FromQuery (Name = "date")][Required()][RegularExpression("^[0-9]{8}$")]string date)
        {
        ...
        public virtual IActionResult GetProfile([FromRoute (Name = "userId")][Required]string userId)
        {
        ...
        public virtual IActionResult GetRichMenu([FromRoute (Name = "richMenuId")][Required]string richMenuId)
        {
        ...
        public virtual IActionResult GetRichMenuAlias([FromRoute (Name = "richMenuAliasId")][Required]string richMenuAliasId)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(RichMenuAliasListResponse), description: "OK")]
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(RichMenuBatchProgressResponse), description: "OK")]
        public virtual IActionResult GetRichMenuBatchProgress([FromQuery (Name = "requestId")][Required()]string requestId)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(RichMenuIdResponse), description: "OK")]
        public virtual IActionResult GetRichMenuIdOfUser([FromRoute (Name = "userId")][Required]string userId)
        {
        ...
        public virtual IActionResult GetRoomMemberCount([FromRoute (Name = "roomId")][Required]string roomId)
        {
        ...
        public virtual IActionResult GetRoomMemberProfile([FromRoute (Name = "roomId")][Required]string roomId, [FromRoute (Name = "userId")][Required]string userId)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(MembersIdsResponse), description: "OK")]
        public virtual IActionResult GetRoomMembersIds([FromRoute (Name = "roomId")][Required]string roomId, [FromQuery (Name = "start")]string start)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(GetWebhookEndpointResponse), description: "OK")]
        ...
        public virtual IActionResult IssueLinkToken([FromRoute (Name = "userId")][Required]string userId)
        {
        ...
        public virtual IActionResult LeaveGroup([FromRoute (Name = "groupId")][Required]string groupId)
        {
        ...
        public virtual IActionResult LeaveRoom([FromRoute (Name = "roomId")][Required]string roomId)
        {
        ...
        public virtual IActionResult LinkRichMenuIdToUser([FromRoute (Name = "userId")][Required]string userId, [FromRoute (Name = "richMenuId")][Required]string richMenuId)
        {
        ...
        public virtual IActionResult LinkRichMenuIdToUsers([FromBody]RichMenuBulkLinkRequest richMenuBulkLinkRequest)
        {
        ...
        public virtual IActionResult MarkMessagesAsRead([FromBody]MarkMessagesAsReadRequest markMessagesAsReadRequest)
        {
        ...
        [SwaggerResponse(statusCode: 409, type: typeof(ErrorResponse), description: "Conflict")]
        [SwaggerResponse(statusCode: 429, type: typeof(ErrorResponse), description: "Too Many Requests")]
        public virtual IActionResult Multicast([FromBody]MulticastRequest multicastRequest, [FromHeader (Name = "X-Line-Retry-Key")]Guid? xLineRetryKey)
        {
        ...
        [SwaggerResponse(statusCode: 409, type: typeof(ErrorResponse), description: "Conflict")]
        [SwaggerResponse(statusCode: 429, type: typeof(ErrorResponse), description: "Too Many Requests")]
        public virtual IActionResult Narrowcast([FromBody]NarrowcastRequest narrowcastRequest, [FromHeader (Name = "X-Line-Retry-Key")]Guid? xLineRetryKey)
        {
        ...
        [SwaggerResponse(statusCode: 409, type: typeof(ErrorResponse), description: "Conflict")]
        [SwaggerResponse(statusCode: 429, type: typeof(ErrorResponse), description: "Too Many Requests")]
        public virtual IActionResult PushMessage([FromBody]PushMessageRequest pushMessageRequest, [FromHeader (Name = "X-Line-Retry-Key")]Guid? xLineRetryKey)
        {
        ...
        [SwaggerResponse(statusCode: 422, type: typeof(ErrorResponse), description: "Unprocessable Entity")]
        public virtual IActionResult PushMessagesByPhone([FromBody]PnpMessagesRequest pnpMessagesRequest, [FromHeader (Name = "X-Line-Delivery-Tag")][StringLength(100, MinimumLength=16)]string xLineDeliveryTag)
        {
        ...
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad request")]
        [SwaggerResponse(statusCode: 429, type: typeof(ErrorResponse), description: "Too Many Requests")]
        public virtual IActionResult ReplyMessage([FromBody]ReplyMessageRequest replyMessageRequest)
        {
        ...
        public virtual IActionResult RichMenuBatch([FromBody]RichMenuBatchRequest richMenuBatchRequest)
        {
        ...
        public virtual IActionResult SetDefaultRichMenu([FromRoute (Name = "richMenuId")][Required]string richMenuId)
        {
        ...
        public virtual IActionResult SetWebhookEndpoint([FromBody]SetWebhookEndpointRequest setWebhookEndpointRequest)
        {
        ...
        [SwaggerResponse(statusCode: 202, type: typeof(Object), description: "Accepted")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "An invalid chat ID is specified, or the loadingSeconds value is invalid.")]
        public virtual IActionResult ShowLoadingAnimation([FromBody]ShowLoadingAnimationRequest showLoadingAnimationRequest)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(TestWebhookEndpointResponse), description: "OK")]
        public virtual IActionResult TestWebhookEndpoint([FromBody]TestWebhookEndpointRequest testWebhookEndpointRequest)
        {
        ...
        public virtual IActionResult UnlinkRichMenuIdFromUser([FromRoute (Name = "userId")][Required]string userId)
        {
        ...
        public virtual IActionResult UnlinkRichMenuIdFromUsers([FromBody]RichMenuBulkUnlinkRequest richMenuBulkUnlinkRequest)
        {
        ...
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        public virtual IActionResult UpdateRichMenuAlias([FromRoute (Name = "richMenuAliasId")][Required]string richMenuAliasId, [FromBody]UpdateRichMenuAliasRequest updateRichMenuAliasRequest)
        {
        ...
        public virtual IActionResult ValidateBroadcast([FromBody]ValidateMessageRequest validateMessageRequest)
        {
        ...
        public virtual IActionResult ValidateMulticast([FromBody]ValidateMessageRequest validateMessageRequest)
        {
        ...
        public virtual IActionResult ValidateNarrowcast([FromBody]ValidateMessageRequest validateMessageRequest)
        {
        ...
        public virtual IActionResult ValidatePush([FromBody]ValidateMessageRequest validateMessageRequest)
        {
        ...
        public virtual IActionResult ValidateReply([FromBody]ValidateMessageRequest validateMessageRequest)
        {
        ...
        public virtual IActionResult ValidateRichMenuBatchRequest([FromBody]RichMenuBatchRequest richMenuBatchRequest)
        {
        ...
        public virtual IActionResult ValidateRichMenuObject([FromBody]RichMenuRequest richMenuRequest)
        {
