...
{ 
    ...
    { 
        ...
        public virtual IActionResult ActivateAudienceGroup([FromRoute (Name = "audienceGroupId")][Required]long audienceGroupId)
        {
        ...
        public virtual IActionResult AddAudienceToAudienceGroup([FromBody]AddAudienceToAudienceGroupRequest addAudienceToAudienceGroupRequest)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(CreateAudienceGroupResponse), description: "OK")]
        public virtual IActionResult CreateAudienceGroup([FromBody]CreateAudienceGroupRequest createAudienceGroupRequest)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(CreateClickBasedAudienceGroupResponse), description: "OK")]
        public virtual IActionResult CreateClickBasedAudienceGroup([FromBody]CreateClickBasedAudienceGroupRequest createClickBasedAudienceGroupRequest)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(CreateImpBasedAudienceGroupResponse), description: "OK")]
        public virtual IActionResult CreateImpBasedAudienceGroup([FromBody]CreateImpBasedAudienceGroupRequest createImpBasedAudienceGroupRequest)
        {
        ...
        public virtual IActionResult DeleteAudienceGroup([FromRoute (Name = "audienceGroupId")][Required]long audienceGroupId)
        {
        ...
        public virtual IActionResult GetAudienceData([FromRoute (Name = "audienceGroupId")][Required]long audienceGroupId)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(GetAudienceGroupAuthorityLevelResponse), description: "OK")]
        public virtual IActionResult GetAudienceGroupAuthorityLevel()
        {
            ...
            var example = exampleJson != null
            ? JsonSerializer.Deserialize<GetAudienceGroupAuthorityLevelResponse>(exampleJson)
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(GetAudienceGroupsResponse), description: "OK")]
        public virtual IActionResult GetAudienceGroups([FromQuery (Name = "page")][Required()]long page, [FromQuery (Name = "description")]string description, [FromQuery (Name = "status")]AudienceGroupStatus? status, [FromQuery (Name = "size")]long? size, [FromQuery (Name = "includesExternalPublicGroups")]bool? includesExternalPublicGroups, [FromQuery (Name = "createRoute")]AudienceGroupCreateRoute? createRoute)
        {
        ...
        public virtual IActionResult UpdateAudienceGroupAuthorityLevel([FromBody]UpdateAudienceGroupAuthorityLevelRequest updateAudienceGroupAuthorityLevelRequest)
        {
        ...
        public virtual IActionResult UpdateAudienceGroupDescription([FromRoute (Name = "audienceGroupId")][Required]long audienceGroupId, [FromBody]UpdateAudienceGroupDescriptionRequest updateAudienceGroupDescriptionRequest)
        {
