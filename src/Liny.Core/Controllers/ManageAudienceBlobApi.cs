...
{ 
    ...
    { 
        ...
        public virtual IActionResult AddUserIdsToAudience([Required()]IFormFile file, [FromForm (Name = "audienceGroupId")]long? audienceGroupId, [FromForm (Name = "uploadDescription")]string uploadDescription)
        {
        ...
        public virtual IActionResult CreateAudienceForUploadingUserIds([Required()]IFormFile file, [FromForm (Name = "description")] [MaxLength(120)]string description, [FromForm (Name = "isIfaAudience")]bool? isIfaAudience, [FromForm (Name = "uploadDescription")]string uploadDescription)
        {
