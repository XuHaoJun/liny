...
namespace Liny.Core.Controllers
{
    ...
    public class ChannelAccessTokenApiController : ControllerBase
    {
        ...
        [SwaggerResponse(
            statusCode: 200,
            type: typeof(ChannelAccessTokenKeyIdsResponse),
            description: "OK"
        )]
        public virtual IActionResult GetsAllValidChannelAccessTokenKeyIds(
            [FromQuery(Name = "client_assertion_type")] [Required()] string clientAssertionType,
            [FromQuery(Name = "client_assertion")] [Required()] string clientAssertion
        )
        {
        ...
        )
        {
            ...
            var example =
                exampleJson != null
                    ? JsonSerializer.Deserialize<IssueShortLivedChannelAccessTokenResponse>(
                        exampleJson
                    )
        ...
        [SwaggerResponse(
            statusCode: 200,
            type: typeof(IssueChannelAccessTokenResponse),
            description: "OK"
        )]
        public virtual IActionResult IssueChannelTokenByJWT(
            [FromForm(Name = "grant_type")] [Required()] string grantType,
            [FromForm(Name = "client_assertion_type")] [Required()] string clientAssertionType,
            [FromForm(Name = "client_assertion")] [Required()] string clientAssertion
        )
        {
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
        ...
        [SwaggerResponse(
            statusCode: 200,
            type: typeof(IssueStatelessChannelAccessTokenResponse),
            description: "OK"
        )]
        public virtual IActionResult IssueStatelessChannelToken(
        ...
        )
        {
            ...
            var example =
                exampleJson != null
                    ? JsonSerializer.Deserialize<IssueStatelessChannelAccessTokenResponse>(
                        exampleJson
                    )
        ...
        public virtual IActionResult RevokeChannelToken(
            [FromForm(Name = "access_token")] [Required()] string accessToken
        )
        {
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
        ...
        public virtual IActionResult RevokeChannelTokenByJWT(
            [FromForm(Name = "client_id")] [Required()] string clientId,
            [FromForm(Name = "client_secret")] [Required()] string clientSecret,
            [FromForm(Name = "access_token")] [Required()] string accessToken
        )
        ...
        [SwaggerResponse(
            statusCode: 200,
            type: typeof(VerifyChannelAccessTokenResponse),
            description: "OK"
        )]
        public virtual IActionResult VerifyChannelToken(
            [FromForm(Name = "access_token")] [Required()] string accessToken
        )
        {
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
        ...
        public virtual IActionResult VerifyChannelTokenByJWT(
            [FromQuery(Name = "access_token")] [Required()] string accessToken
        )
        {
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(VerifyChannelAccessTokenResponse));
